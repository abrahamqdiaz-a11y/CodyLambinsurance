            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-navy-100/50 p-8 md:p-10 border border-navy-100">
              {submitted ? (
                ...
                <form
                  ...
                  aria-label="Commercial insurance quote request form"
                  noValidate
                >
                  ...
                  <h3 className="font-display text-xl font-bold text-navy-800 mb-7">Get a Business Quote</h3>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="business-name" className={labelClass}>Business Name <span className="text-red-500">*</span></label>
                      <input id="business-name" type="text" name="business-name" required autoComplete="organization" placeholder="Acme LLC" className={inputClass} />
                    </div>

                    <div className="sm:col-span-2">
                      <label htmlFor="address" className={labelClass}>Business Address <span className="text-red-500">*</span></label>
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="industry" className={labelClass}>Industry / Type of Business <span className="text-red-500">*</span></label>
                      <input id="industry" type="text" name="industry" required autoComplete="off" placeholder="e.g. Contractor, Restaurant, Retail, Professional Services" className={inputClass} />
                    </div>

                    <div className="sm:col-span-2">
                      <label htmlFor="coverage-type" className={labelClass}>Coverage Interested In <span className="text-red-500">*</span></label>
                      <select id="coverage-type" name="coverage-type" required className={`${inputClass} cursor-pointer`}>
                        <option value="">Select coverage type…</option>
                        <option value="General Liability">General Liability</option>
                        <option value="BOP">Business Owner&apos;s Policy (BOP)</option>
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="message" className={labelClass}>Additional Details <span className="ml-1 text-navy-400 font-normal">(optional)</span></label>
                      <textarea id="message" name="message" rows={4} placeholder="Tell us about your business and what you're looking to protect…" className={inputClass} />
                    </div>
                  </div>
                  ...
                  <button type="submit" disabled={loading} className="btn-primary mt-7 w-full py-4 rounded-lg font-semibold font-body text-base flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed">
                    {loading ? "Sending…" : "Get My Business Quote"}
                  </button>
