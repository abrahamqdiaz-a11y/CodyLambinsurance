        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="animate-on-scroll">
            ...
            <div className="space-y-4 text-navy-600 font-body text-base leading-relaxed mb-8">
              <p>
                Lamb Insurance Agency is a licensed insurance agency based in Sarasota, Florida. We work directly with clients — no handoffs, no hold music, no automated systems.
              </p>
              <p>
