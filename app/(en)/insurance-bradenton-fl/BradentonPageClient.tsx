      ...
      <div className="max-w-6xl mx-auto px-5">
        <div className="max-w-4xl animate-on-scroll">
          ...
          <div className="space-y-4 text-navy-600 font-body text-base leading-relaxed">
            ...
            <p>
              If you&apos;re buying in downtown Bradenton, Palma Sola, or any older neighborhood and you haven&apos;t had a wind mitigation inspection, that&apos;s the first call to make — before you renew, not after. If your carrier sends a roof age non-renewal, <Link href="/insights/florida-roof-age-non-renewal" className="text-sage-700 underline hover:text-sage-800">Florida&apos;s 15-year rule gives you the right to an inspection before you are required to replace anything</Link>. Wind coverage in Florida also typically comes with a percentage named storm deductible rather than a flat dollar amount. Our guide covers <Link href="/insights/florida-hurricane-deductible" className="text-sage-700 underline hover:text-sage-800">the named storm deductible structure</Link> and the annual rule that matters most in an active season.
            </p>
          </div>
        </div>
      </div>
