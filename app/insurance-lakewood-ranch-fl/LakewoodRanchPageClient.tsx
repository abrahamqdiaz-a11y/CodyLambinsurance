      ...
      <div className="max-w-6xl mx-auto px-5">
        <div className="max-w-4xl animate-on-scroll">
          ...
          <div className="space-y-4 text-navy-600 font-body text-base leading-relaxed">
            ...
            <p>
              Windstorm and hurricane coverage is often excluded from standard Florida homeowners policies. Unlike a typical HO-3 in Ohio or Pennsylvania, your Florida policy may require a separate windstorm endorsement or a Citizens Insurance policy to cover storm damage. When windstorm coverage is included, it typically comes with a percentage named storm deductible rather than a flat dollar amount -- our guide explains <Link href="/insights/florida-hurricane-deductible" className="text-sage-700 underline hover:text-sage-800">when that deductible triggers</Link> and how the annual credit rule works. Flood is always separate, under any homeowners policy in any state — but it matters more here, where FEMA flood maps cover parts of Lakewood Ranch and tropical systems are an annual reality.
            </p>
            <p>
